...
def optimize_learning_rate(X_train, y_train, weights_train):
    ...
    # Analyse des résultats et tracé 
...
if __name__ == "__main__":
    ...
    # Récupération directe des données via le module externe 'get_data.py'
    X_train, X_test, y_train, y_test, weights_train, weights_test = get_clean_splits()
    
    # Lancement direct de la recherche du meilleur learning rate
